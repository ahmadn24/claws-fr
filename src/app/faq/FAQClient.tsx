...
const faq = [
  ...
  // INSTALLATION
  { cat: "Installation", q: "Combien de temps prend l'installation ?", a: "Une installation standard prend entre 2 et 4 heures pour un technicien. Claws installe et configure OpenClaw en 2 heures ouvrées, sans que vous ayez à toucher une ligne de commande." },
